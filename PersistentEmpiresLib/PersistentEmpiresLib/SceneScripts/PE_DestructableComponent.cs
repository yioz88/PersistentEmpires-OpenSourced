...
namespace PersistentEmpiresLib.SceneScripts
{
    public abstract class PE_DestructableComponent : SynchedMissionObject
    {
        ...
        protected override abstract bool OnHit(Agent victimAgent, Agent attackerAgent, int damage, Vec3 impactPosition, Vec3 impactDirection, in MissionWeapon weapon, ScriptComponentBehavior attackerScriptComponentBehavior, out bool reportDamage);
    }
}
